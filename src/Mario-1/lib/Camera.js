...
export default class Camera {
	...
	update(dt) {
		 ...
		 * Rendering fractional camera offsets will result in weird pixelation and artifacting as
		 * things are attempted to be drawn fractionally and then forced onto a small canvas.
		 */
		if (keys.a) {
